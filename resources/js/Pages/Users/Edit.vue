<template>
    <div class="bg-gray-800 rounded-2xl shadow-2xl p-6">
      <h1 class="text-2xl font-bold text-gray-100 mb-6">Tahrirlash</h1>
      ...
      <form @submit.prevent="submit" class="space-y-4">
        <div>
          ...
          <input
            ...
            v-model="form.name"
            type="text"
            class="mt-1 w-full rounded-md border-gray-600 bg-gray-700 text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <div>
          <label for="password" class="block text-sm font-medium text-gray-300">Parol (o'zgartirish uchun kiriting)</label>
          <input
            id="password"
        ...
        <div class="flex justify-end gap-4">
          ...
          <button
            ...
            :class="{ 'bg-red-600 hover:bg-red-500': hasFormError }"
          >
            Saqlash
          </button>
        </div>
