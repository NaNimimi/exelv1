    ...
    <div>
        ...
        <div class="w-full h-full text-gray-100 flex flex-col">
            ...
            <h1 class="text-4xl font-bold tracking-tight text-white">Rollar</h1>
            ...
            <div class="bg-gray-800 rounded-2xl shadow-2xl w-full h-full flex flex-col">
                ...
                <table class="w-full table-auto">
                    ...
                    <tr class="bg-gradient-to-r from-indigo-900 to-indigo-800 text-gray-300 sticky top-0">
                        ...
                        <th class="p-6 text-left font-semibold text-sm uppercase tracking-wider text-gray-400">Nomi</th>
                        <th class="p-6 text-left font-semibold text-sm uppercase tracking-wider text-gray-400">Ruxsatlar</th>
                    ...
                    >
                        <td class="p-6 text-gray-400">{{ role.id }}</td>
                        <td class="p-6 text-gray-100 font-medium">{{ role.name }}</td>
            ...
            <div class="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md">
                <div class="p-6">
                <h2 class="text-lg font-semibold text-gray-100 mb-4">Rolni o'chirish</h2>
