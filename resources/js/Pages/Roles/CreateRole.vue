<template>
  <div class="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Rol yaratish</h2>

    <form @submit.prevent="submit" class="space-y-6">
      <div>
        <label for="name" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Rol nomi</label>
        <input
          id="name"
